...
# inference methods
    def _get_testvideo_path(self,sample):
        ...
        full_video_fp = os.path.join("/public/home/lianzheng/hjh/dataset/MIntRec/video", video_filename)
        return full_video_fp

    def _get_testaudio_path(self,sample):
        """返回每轮speaker的音频文件路径"""
        audio_filename = f"{sample['name']}.wav"
        full_audio_fp = os.path.join("/public/home/lianzheng/hjh/dataset/MIntRec/audio", audio_filename)
