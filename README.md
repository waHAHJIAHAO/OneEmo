...
- [ms-swift](https://github.com/modelscope/ms-swift): for providing an efficient and easy-to-use training framework.
- [AffectGPT](https://github.com/zeroQiaoba/AffectGPT): whose dataset and evaluation toolkit provided important references and foundations for building the emotion understanding task benchmarks.
